...
export function getGasAnalyticsManager(hookContextOrHre) {
    assertHardhatInvariant(hookContextOrHre instanceof HardhatRuntimeEnvironmentImplementation &&
        hookContextOrHre._gasAnalytics !== undefined, "Expected _gasAnalytics to be installed on the HRE");
